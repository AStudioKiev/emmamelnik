...
$(function() {
    $(document.body).on('appear', '.overflowed-animation', function(e, $affected) {
        $(this).addClass("appeared");
    });

    $('.overflowed-animation').appear({force_process: true});
});
$(function() {
...
$(function() {
    $(document.body).on('appear', '.popup-left-lg', function(e, $affected) {
        $(this).addClass("appeared");
    });

    $('.popup-left-lg').appear({force_process: true});
});
